...
var butFive = new Button("Brush", 50, 280, 120, 40, colArray[0][1], colArray[0][1], colArray[2][2], colArray[2][0], canvas);
var butSix = new Button("Square", 50, 370, 120, 40, colArray[0][1], colArray[0][1], colArray[2][2], colArray[2][0], canvas);
var butSeven = new Button("Diamond", 50, 420, 120, 40, colArray[0][1], colArray[0][1], colArray[2][2], colArray[2][0], canvas);
objectSet.push(butOne, butTwo, butThree, butFour, butFive, butSix, butSeven);

...
var w1 = new width_Button("XS", 5, 290, 30, 30, 2, colArray[0][1], colArray[0][1], colArray[1][5], colArray[2][0], canvas);
var w2 = new width_Button("S", 50, 290, 30, 30, 5, colArray[0][1], colArray[0][1], colArray[1][5], colArray[2][0], canvas);
var w3 = new width_Button("M", 95, 290, 30, 30, 10, colArray[0][1], colArray[0][1], colArray[1][5], colArray[2][0], canvas);
var w4 = new width_Button("L", 140, 290, 30, 30, 15, colArray[0][1], colArray[0][1], colArray[1][5], colArray[2][0], canvas);
var w5 = new width_Button("XL", 185, 290, 30, 30, 20, colArray[0][1], colArray[0][1], colArray[1][5], colArray[2][0], canvas);

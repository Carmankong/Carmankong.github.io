...
var colArray=[
    [
        "rgba(255,255,255,1)", "rgba(0,0,0,1)", "rgba(153,153,153,1)", 
        "rgba(200,0,0,1)","rgba(255,204,51,1)","rgba(51,51,255,1)",
    ...
    [
        "rgba(255,255,255,0.67)", "rgba(0,0,0,0.67)", "rgba(153,153,153,0.67)",
        "rgba(200,0,0,0.67)","rgba(255,204,51,0.67)","rgba(51,51,255,0.67)",
    ...
    [
        "rgba(255,255,255,0.33)", "rgba(0,0,0,0.33)", "rgba(153,153,153,0.33)",
        "rgba(200,0,0,0.33)","rgba(255,204,51,0.33)","rgba(51,51,255,0.33)",
    ...
    [
        "rgba(255,255,255,0.2)", "rgba(0,0,0,0.2)", "rgba(153,153,153,0.2)",
        "rgba(200,0,0,0.2)","rgba(255,204,51,0.2)","rgba(51,51,255,0.2)",
